...
class _Ranking_Last_Page extends State<Ranking_Last_Page>{
  @override
  Widget build(BuildContext context) {
    // スコア順にソート (score + plusscore)
    ranking.sort((a, b) => (b.score + b.plusscore).compareTo(a.score + a.plusscore));
    return Container(
              ...
              Positioned(
                ...
                child: ElevatedButton(
                  onPressed: (){
                    ...
                    MaterialPageRoute(builder: (context) => GameOver_Page()));
                  }, 
