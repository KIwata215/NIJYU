                      ...
                      children: List.generate(5, (index) {
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: _selectedParticipants == index + 2 ? Colors.yellow : Colors.transparent,
                              borderRadius: BorderRadius.circular(20),
                            ),
                            child: Text(
                              '${index + 2}',
                              style: TextStyle(
                                fontSize: _selectedParticipants == number ? 18.sp : 12.sp,
                                color: Colors.white,
                                fontWeight: FontWeight.bold,
                                shadows: _selectedParticipants == index + 2
                                    ? [
                                        Shadow(
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                          labelText: '4文字以内',
                          labelStyle: TextStyle(fontSize: 6.sp, color: Colors.black),
                          filled: true,
