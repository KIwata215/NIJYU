                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize:
                                  _selectedGameRound == number ? 14.sp : 10.sp,
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                    ...
                    children: [
                      Checkbox(
                        value: _isChecked[index] == false &&
                                _countSelected() >= _selectedGameRound
                            ? null
                            : _isChecked[index],
                        onChanged: (bool? value) {
                          setState(() {
                            ...
                            _selectedCount =
                                _isChecked.where((item) => item).length;
                          });
                        },
                        tristate: true,
                        fillColor: _isChecked[index] == false &&
                                _countSelected() >= _selectedGameRound
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Provider.of<RoundProvider>(context, listen: false)
                          .setGameRound(_selectedGameRound);
                      print('選択ラウンド：${_selectedGameRound}');
                      Provider.of<RoundProvider>(context, listen: false)
                          .setSelectMaps(_isChecked);
                      print('選択マップ：${_isChecked}');
